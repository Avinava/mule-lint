    ...
    server.registerResource(
        ...
        new ResourceTemplate('mule-lint://docs/{slug}', {
            ...
            list: () => {
                return {
                    resources: [
                        { uri: 'mule-lint://docs/architecture', name: 'Architecture', mimeType: 'text/markdown' },
                        { uri: 'mule-lint://docs/best-practices', name: 'Best Practices', mimeType: 'text/markdown' },
                        { uri: 'mule-lint://docs/documentation-standards', name: 'Documentation Standards', mimeType: 'text/markdown' },
                        { uri: 'mule-lint://docs/extending', name: 'Extending', mimeType: 'text/markdown' },
                        { uri: 'mule-lint://docs/folder-structure', name: 'Folder Structure', mimeType: 'text/markdown' },
                        { uri: 'mule-lint://docs/naming', name: 'Naming Conventions', mimeType: 'text/markdown' },
                        { uri: 'mule-lint://docs/rules-catalog', name: 'Rules Catalog', mimeType: 'text/markdown' },
                    ],
                };
            },
        }),
